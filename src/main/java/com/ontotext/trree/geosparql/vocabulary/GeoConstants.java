 ...
 * the License.
 */
package com.ontotext.trree.geosparql.vocabulary;
...
public interface GeoConstants {
    ...
    IRI GEOF_WITHIN_DISTANCE = SimpleValueFactory.getInstance().createIRI(NS_GEOF + "withinDistance");
    ...
    IRI GEOF_CENTROID = SimpleValueFactory.getInstance().createIRI(NS_GEOF + "centroid");
    IRI GEOF_CONCAVE_HULL = SimpleValueFactory.getInstance().createIRI(NS_GEOF + "concaveHull");
